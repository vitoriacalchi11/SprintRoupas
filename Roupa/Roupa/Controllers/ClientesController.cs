...
namespace Roupa.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,Nome,Endereco,Telefone,CPF,Email,DataNasc")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ClienteId,Nome,Endereco,Telefone,CPF,Email,DataNasc")] Cliente cliente)
        {
